  ...
  sidebarLayout(
    sidebarPanel(width = 3,
                 selectInput("modelSelect", "Model",
                            # choices = list_models,
                              choices = fileList,
                              # choices = list("data/adornedText.bin",  "wwp_model_adorned" , "wwp_model_unadorned" ),
                              selected = 1),
...
server <- function(input, output) {
  ...
  output$basic_table <- DT::renderDataTable(DT::datatable({
    ...
    data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(input$basic_word1, input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
  ...
  output$addition_table <- DT::renderDataTable(DT::datatable({
    ...
    data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$addition_word1,] + list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$addition_word2,], input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
  ...
  output$subtraction_table <- DT::renderDataTable(DT::datatable({
    ...
    data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$subtraction_word1,] - list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$subtraction_word2,], input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
  ...
  output$analogies_table <- DT::renderDataTable(DT::datatable({
    ...
    data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$analogies_word1,] - list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$analogies_word2,] + list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$analogies_word3,], input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
  ...
  output$advanced_table <- DT::renderDataTable(DT::datatable({
    ...
    data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(input$advanced_word1, input$all_count)
    if (input$advanced_word2 != "" && input$advanced_word3 == "") {
      if (input$advanced_math == "+") {
        data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word1,] + list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word2,], input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
      }
      if (input$advanced_math == "-") {
        data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word1,] - list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word2,], input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
      }
    ...
    if (input$advanced_word2 != "" && input$advanced_word3 != "") {
      ...
      if (input$advanced_math == "+" && input$advanced_math2 == "+") {
        data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word1,] + list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word2,] + list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word3,], input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
      }
      if (input$advanced_math == "+" && input$advanced_math2 == "-") {
        data <- list_models[[input$modelSelect[[1]]]] %>% closest_to(list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word1,] + list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word2,] - list_models[[input$modelSelect[[1]]]][rownames(list_models[[input$modelSelect[[1]]]])==input$advanced_word3,], input$all_count) %>% mutate("Link" <- paste0("<a target='_blank' href='http://wwo.wwp.northeastern.edu/WWO/search?keyword=", .$word,"'>",.$word,"</a>")) %>% .[c(3,2)]
      }
